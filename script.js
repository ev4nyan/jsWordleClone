...
function addGuess(e) {
    ...
    (guessInput.value.length === 5) &&
     (arrayWords.includes(guessInput.value) ||
      (allowedWords.includes(guessInput.value)))){
...
function fiveLetter(){
    if(guessInput.value.length === 5 && !((arrayWords.includes(guessInput.value) ||
    (allowedWords.includes(guessInput.value))))) {
    ...
    if (guessInput.value.length >= 6 || /\s/g.test(guessInput.value)) {
